...
// C/C++ source code generated on : Wed May 06 10:24:29 2026
//
...
#define ROS_SET_RTM_ERROR_STATUS(status) controller_M->setErrorStatus(status)
#define ROS_GET_RTM_ERROR_STATUS()     controller_M->getErrorStatus()
#define ROS_RTM_STEP_TASK(id)          controller_M->StepTask(id)
  ...
  namespace matlab
  {
    ...
    void NodeInterface::initialize(int argc, char ** argv)
    {
      try {
        ...
        ROS_INFO("** Starting the model \"controller\" **\n");
    ...
    boolean_T NodeInterface::getStopRequestedFlag(void)
    {
      ...
      return (!(ROS_GET_RTM_ERROR_STATUS()
                == (NULL)) || rtmGetStopRequested(controller_M));
