...
runuser -l $LIBPANDA_USER -c /etc/libpanda.d/apps/controller/installRosPackages.sh
...
rosrun robot_upstart install controller/launch/${LAUNCH_FILE} --user root
